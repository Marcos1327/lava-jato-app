        ...
        <div className="container">
            <div className="sidebar">
                ...
                <div className="button-group">
                    <NavLink className="button"><img src={AtendimentoIcon} alt="Atendimento" className="button-icon" />Atendimentos</NavLink>
                    <NavLink className="button"><img src={ArquivadosIcon} alt="Arquivados" className="button-icon" />Arquivados</NavLink>
                    ...
                    <div className="divider" />
                    <NavLink className="button"><img src={CaixaIcon} alt="Caixa" className="button-icon" />Caixa</NavLink>
                    <NavLink className="button"><img src={RelatorioIcon} alt="Relatório" className="button-icon" />Relatório</NavLink>
                </div>
